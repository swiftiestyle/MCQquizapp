...
public class moviequestions extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_moviequestions);
        ...
        showanswer1=(Button)findViewById(R.id.showanswer1);
        mmques = FirebaseDatabase.getInstance().getReference().child("Movies");
        ...
        but1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ( radiob1.isChecked() || radiob2.isChecked() || radiob3.isChecked() ) {
                    ...
                    Toast.makeText(moviequestions.this,"PLEASE SELECT AN OPTION",Toast.LENGTH_LONG).show();
            ...
            public void onClick(View view) {
                ...
                mqu.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        Toast.makeText(moviequestions.this, "The Answer Is " + aa1, Toast.LENGTH_LONG).show();
                    }
        ...
        if(radiob1.isChecked()){
            ...
            if(radiob1.getText().toString().equals(answer1)) {
                if (num1 < (d+1)) {
                    ...
                    rg1.clearCheck();
                    updatequestion1();
                    Toast.makeText(moviequestions.this, "Correct", Toast.LENGTH_LONG).show();
            ...
            {
                if (num1 < (d+1)) {
                    Toast.makeText(moviequestions.this, "Wrong", Toast.LENGTH_LONG).show();
                    num1++;
                    quno1++;
                    rg1.clearCheck();
                    updatequestion1();
    ...
    private void updatequestion1()
    {
        ...
        if(scorevalue1==(d+1))
        {
            ...
            else if(num1<(d+1))
            {
                ...
                mque=mmques1.child("Question");

                mque.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
